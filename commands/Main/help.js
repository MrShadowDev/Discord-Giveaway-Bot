  ...
  run: async (client, message, args) => {
    ...
    const embed = new MessageEmbed()
      .setAuthor(
        ...
        'https://github.com/MrShadowDev/'
      )
      .setThumbnail(client.user.displayAvatarURL({ ...avatarOptions }))
      .setTitle('Help')
      .setURL('https://github.com/MrShadowDev/')
      .setColor('7289da')
      .setDescription(`You want to create a giveaway bot yourself?\n[Check out our Github page!](https://github.com/MrShadowDev/)`)
      .addFields({
      ...
      .setFooter('Made with 💖 and discord.js by MrShadowDev', client.user.displayAvatarURL({ ...avatarOptions }))
